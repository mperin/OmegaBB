...
language_hash["FAQ"] = "text her€";
language_hash["Status"] = "text here";
language_hash["Terms Of Service"] = "text here";
language_hash["Contact"] = "text here";
language_hash["Emotes"] = "text here";
language_hash["About"] = "text here";
language_hash["Main"] = "text here";
language_hash["News"] = "text here";
language_hash["Articles"] = "text here";
language_hash["Archive"] = "text here";
language_hash["invalid configuration, you may only have up to six forum tabs"] = "text here"
language_hash["Make New Account"] = "text here";
...
language_hash["Dark Blue"] = "text here";
language_hash["Dark Red"] = "text here";
language_hash["Green"] = "text here";
language_hash["Black and White"] = "text here";
language_hash["New Dark Blue"] = "text here";
language_hash["New Dark Red"] = "text here";
language_hash["New Green"] = "text here";
language_hash["Black and Green"] = "text here";
...
language_hash["Names of the tabs used by the forum.  How many forum tabs are displayed depends on how many forums you have set, and how many "
	+ "forums per tab (see Miscellaneous Settings).  Even if you're using less than six, they all need to be here, just edit the ones relevant to your configuration"] = "text here";
